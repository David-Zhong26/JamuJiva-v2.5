...
const linkClass = 'font-medium text-[#2F4F3A]/80 hover:text-[#F47C3E]';
const headingClass = 'mb-4 font-serif text-lg font-bold text-[#2D4F3E]';
      ...
      <div className="mx-auto max-w-7xl">
        <div className="md:flex md:items-start md:justify-between md:gap-12">
          <div className="max-w-xs">
            ...
            <p className="font-medium text-[#2F4F3A]/80">
        ...
        <div className="mt-12 border-t border-[#2D4F3E]/5 pt-8 md:mt-20 md:flex md:items-center md:justify-between md:pt-10">
          <p className="text-sm font-medium text-[#2F4F3A]/50 md:hidden">© 2026 Jiva Drinks LLC.</p>
