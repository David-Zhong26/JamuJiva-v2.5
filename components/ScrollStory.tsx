...
const ScrollStory: React.FC<ScrollStoryProps> = ({ email, setEmail, onJoin, joined }) => {
  ...
  const bottleX = useTransform(
    ...
    [140, 140, 140, -220, -220, 0, 320, 320, 320]
  );
  ...
  // ——— Background: background.jpg from the start for top section; fades out as green takes over ———
  const bgBackgroundOpacity = useTransform(smoothProgress, [0, 0.14, 0.22], [1, 0.2, 0]);
